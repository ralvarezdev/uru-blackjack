...
int main()
{
    ...
    do
    {
        ...
        for (x = 0; x < tablero.numeroJugadores; x++)
        {
            ...
            else if (dinero >= tablero.apuestaInicial)
            {
        ...
        do
        {
            y = 0;
            for (x = 0; x < tablero.numeroJugadores; x++)
                if (jugadoresStats[x].bancarrota == true || jugadoresStats[x].stand == true || jugadoresStats[x].out == true)
                    y++;
                else
                {
                    tablero.imprimirStats(titulo, mesaStats.apuestas, jugadoresStats);
                    ...
                    bool r = seleccionSimple("Desea retirarse?");
                    if (r == true)
